        ...
        for item in conn_reg:
            if item['reg_info']['reg_name'] != '':
                if item['reg_info']['reg_name'] not in links:
                    ...
                    links[item['reg_info']['reg_name']] = {'source':self.domain,'target':item['reg_info']['reg_name'],'name':item['conn'],'des':conn_type_info}
                ...
                elif conn_type_info not in links[item['reg_info']['reg_name']]['des']:
                    links[item['reg_info']['reg_name']]['des'] = links[item['reg_info']['reg_name']]['des'] + '/' + conn_type_info

            if item['reg_info']['reg_email'] != '':
                if item['reg_info']['reg_email'] not in links:
                    nodes.append((item['reg_info']['reg_email'],conn_type))
                    links[item['reg_info']['reg_email']] = {'source':self.domain,'target':item['reg_info']['reg_email'],'name':item['conn'],'des':conn_type_info}
                ...
                elif conn_type_info not in links[item['reg_info']['reg_email']]['des']:
                    links[item['reg_info']['reg_email']]['des'] = links[item['reg_info']['reg_email']]['des'] + '/' + conn_type_info

            if item['reg_info']['reg_phone'] != '':
                if item['reg_info']['reg_phone'] not in links:
                    nodes.append((item['reg_info']['reg_phone'],conn_type))
                    links[item['reg_info']['reg_phone']] = {'source':self.domain,'target':item['reg_info']['reg_phone'],'name':item['conn'],'des':conn_type_info}
                ...
                elif conn_type_info not in links[item['reg_info']['reg_phone']]['des']:
                    links[item['reg_info']['reg_phone']]['des'] = links[item['reg_info']['reg_phone']]['des'] + '/' + conn_type_info
        ...
        for item in conn_reg:
            ...
            if item['reg_name'] != '':
                if item['reg_name'] not in links:
                    ...
                    links[item['reg_name']] = {'source':self.domain,'target':item['reg_name'],'name':conn_item,'des':conn_type_info}
                elif conn_item not in links[item['reg_name']]['name']:
                    links[item['reg_name']]['name'] = links[item['reg_name']]['name'] + '/' + conn_item
                elif conn_type_info not in links[item['reg_name']]['des']:
                    links[item['reg_name']]['des'] = links[item['reg_name']]['des'] + '/' + conn_type_info

            if item['reg_email'] != '':
                if item['reg_email'] not in links:
                    nodes.append((item['reg_email'],conn_type))
                    links[item['reg_email']] = {'source':self.domain,'target':item['reg_email'],'name':conn_item,'des':conn_type_info}
                elif conn_item not in links[item['reg_email']]['name']:
                    links[item['reg_email']]['name'] = links[item['reg_email']]['name'] + '/' + conn_item
                elif conn_type_info not in links[item['reg_email']]['des']:
                    links[item['reg_email']]['des'] = links[item['reg_email']]['des'] + '/' + conn_type_info

            if item['reg_phone'] != '':
                if item['reg_phone'] not in links:
                    nodes.append((item['reg_phone'],conn_type))
                    links[item['reg_phone']] = {'source':self.domain,'target':item['reg_phone'],'name':conn_item,'des':conn_type_info}
                elif conn_item not in links[item['reg_phone']]['name']:
                    links[item['reg_phone']]['name'] = links[item['reg_phone']]['name'] + '/' + conn_item
                elif conn_type_info not in links[item['reg_phone']]['des']:
                    links[item['reg_phone']]['des'] = links[item['reg_phone']]['des'] + '/' + conn_type_info
    ...
    def deal_links_nodes_links(self,nodes,links,links_reg,conn_type):
        ...
        for item in links_reg:
            if item['reg_name'] != '':
                if item['reg_name'] not in links:
                    nodes.append((item['reg_name'],conn_type))
                    links[item['reg_name']] = {'source':self.domain,'target':item['reg_name'],'name':'','des':conn_type_info}
                elif conn_type_info not in links[item['reg_name']]['des']:
                    links[item['reg_name']]['des'] = links[item['reg_name']]['des'] + '/' + conn_type_info
