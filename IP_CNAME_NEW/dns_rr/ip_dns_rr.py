...
if __name__ == '__main__':
    resolver = dns.resolver.Resolver(configure=False)
    dns_message = []
    # print get_cname_ip(['202.108.22.220'],'www.00000f.com',resolver,dns_message)
    ## print dns_message
    g_ns, g_ips, g_cnames,g_soa, g_txt, g_mx, dns_message= [],[],[],[],[],[],[]
    get_complete_dns_rr('www.00000k9.com', g_ns, g_ips, g_cnames,g_soa, g_txt, g_mx,dns_message)
